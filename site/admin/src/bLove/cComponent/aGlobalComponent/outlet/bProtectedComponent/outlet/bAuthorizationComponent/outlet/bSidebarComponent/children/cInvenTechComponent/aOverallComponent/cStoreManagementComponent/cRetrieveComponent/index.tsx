...
import {
  ScrollArea,
  ScrollBar,
} from "@/aConnection/bShadcnConnection/components/ui/scroll-area";
import {
  Table,
  TableBody,
  TableCell,
        ...
        <div className="flex items-center justify-between space-y-2">
          ...
          <div className="hidden lg:flex items-center space-x-2">
            <Button asChild variant="blue">
              <Link
                to={
                  fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute
                    .bSidebarRoute.cInvenTechRoute.aOverallRoute
                    .cStoreManagementRoute.bCreateRoute
                }
              >
                <Edit2Icon />
                Edit
        ...
        <div className="mx-auto grid flex-1 auto-rows-max gap-4">
          ...
          <div className="grid flex-1 items-start gap-4 sm:py-0">
            {data().content.sections.map(
              (eachSection: any, indexSection: number) =>
                eachSection.display && (
                      ...
                      <CardContent className="p-6 text-sm">
                        <div className="grid gap-3">
                          <ul className="grid gap-3 grid-cols-5">
                            {eachSection.values.map(
                              (eachValue: any, indexValue: number) => (
                                <React.Fragment>
                                  {eachValue.type === "normal" && (
                                    ...
                                    >
                                      ...
                                      <span className="w-4/5 truncate text-lg">
                                        {eachValue.value || "--N/A--"}
                                      </span>
                                    </li>
                                  )}
                                  ...
                                  {eachValue.type === "textarea" && (
                                    <li
                                      className="flex flex-col gap-1 items-start justify-between"
                                      key={indexValue}
                                    >
                                      <span className="text-muted-foreground">
                                        {eachValue.label}:
                                                              ...
                                                              (permission) => (
                                                                ...
                                                                >
                                                                  {menuOption
                                                                    ...
                                                                    <OctagonMinus className="text-red-500 h-4 w-4" />
                                                                  )}
                                                                </TableCell>
                                                              )
                                                            )}
                                  ...
                                  {eachValue.type === "data-list" && (
                                    <li
                                      className={cn(
                                        "flex flex-col gap-2 items-start justify-between col-span-5",
                                        eachValue?.style
                                      )}
                                      key={indexValue}
                                    >
                                        ...
                                        <Dialog>
                                          ...
                                          <DialogContent>
                                            ...
                                            <ul className="grid gap-4 grid-cols-2">
                                              ...
                                              <li
                                                className={cn(
                                                  "flex flex-col gap-1 items-start justify-between col-span-5 ",
                                                  eachValue?.style
                                                )}
                                                key={indexValue}
                                              >
                                        ...
                                        <TableBody>
                                          <TableRow>
                                            <TableCell className="font-medium">
                                              INV001 //dsadqwad sadadsad.
                                              hsad9as sadaslkjadlkjsadlksa
                                            </TableCell>
                                          </TableRow>
                                          <TableRow>
                                            <TableCell className="font-medium">
